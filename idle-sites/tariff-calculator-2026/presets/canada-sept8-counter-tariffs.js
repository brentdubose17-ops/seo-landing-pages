...
(function (root, factory) {
  ...
  return {
    ...
    status: 'CONFIRMED — Canada announced Aug 25, 2026 counter-tariffs of 15%, 25% and 50% on C$27.6 billion of US imports, effective 12:01 a.m. ET on Tuesday, September 8, 2026, with each product rate matching the corresponding US rate (products drawn from those targeted by US Section 338 and Section 232 tariffs). Official list: 629 tariff items (413 at 50%, 195 at 25%, 21 at 15%) — revised Aug 26 from the original 874-item list. CRITICAL: US automobiles are NOT on this list (they remain under the separate existing 25% counter-tariff order), and fish/seafood was REMOVED in the Aug 26 revision. Applies only to US-origin goods; US goods already in transit to Canada on Sept 8 are exempt. A C$7.5 billion support package for workers and businesses accompanies the measures. Talks remain suspended as of Aug 31; rates may change if a deal lands — edit this data file to reflect it.',
    source_citations: [
