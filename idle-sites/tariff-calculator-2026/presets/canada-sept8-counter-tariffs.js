...
(function (root, factory) {
  ...
  return {
    ...
    revised: '2026-09-11', // data-file revision: Sept 15 scope change + Sept 29 import bans named correctly (t_c39d6c22). The official 629-item Finance Canada list itself was revised 2026-08-26.
    ...
    source_citations: [
      ...
      'White House Fact Sheet: President Donald J. Trump Responds to Canada\'s Retaliation (Sept 8, 2026) — Sept 15 scope change / Sept 29 import bans — https://www.whitehouse.gov/fact-sheets/2026/09/fact-sheet-president-donald-j-trump-responds-to-canadas-retaliation',
      'USTR: Ambassador Greer statement on the response to Canada\'s continued retaliation (Sept 8, 2026) — https://ustr.gov/about/policy-offices/press-office/press-releases/2026/september/ambassador-greer-issues-statement-president-trumps-response-canadas-continued-retaliation-against',
      ...
      'Canada\'s National Observer: Canada still studying Trump\'s latest trade attack — Carney (Sept 11, 2026) — https://www.nationalobserver.com/2026/09/11/news/canada-still-studying-trumps-latest-trade-attack-carney'
    ]
  };
}));
